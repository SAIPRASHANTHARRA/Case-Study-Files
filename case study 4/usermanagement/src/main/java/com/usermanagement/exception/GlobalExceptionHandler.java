...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleUserMailNotFoundException(UserMailNotFoundException e7){
		ErrorResponse errorResponse7 = new ErrorResponse(HttpStatus.NOT_FOUND.value(),"Usermail Not Found",e7.getMessage());
		return new ResponseEntity<>(errorResponse7,HttpStatus.NOT_FOUND);
	}
