...
public class ReservationController {
	...
	@GetMapping("reservationdetails/reservationsbyguestId/{guestId}")
	public List<Reservation> getReservationByGuestId(@PathVariable Long guestId){
		return reservationService.getReservationsByGuestId(guestId);
	}
	
	@GetMapping("/room/available/{type}/{capacity}/{checkinDate}/{checkoutDate}")
	public List<RoomDTO> getAvailableRoomsByTypeAndCapacity(@PathVariable String type, @PathVariable Integer capacity,@PathVariable LocalDate checkinDate,@PathVariable LocalDate checkoutDate){
		return reservationService.getAvailableRoomsByTypeAndCapacity( type, capacity,checkinDate,checkoutDate);
	}
